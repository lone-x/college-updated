...
--
-- Host: localhost
-- Generation Time: Jun 10, 2024 at 08:16 AM
...
CREATE TABLE `faculties` (
  ...
  `department` enum('IT','EC','EEE','MECH','PT','SH','OTH') NOT NULL,
...
INSERT INTO `faculties` (`id`, `name`, `image_path`, `department`, `position`, `other_position`) VALUES
(4, 'Ms.Anjana B', 'facultyuploads/anjana.jpeg', 'IT', 'HOD', NULL),
(5, 'Dr.Remya Chandran', 'facultyuploads/remya.jpeg', 'IT', 'Assistant Professor', NULL),
(6, 'Ms.Banu Fathima Mariyam', 'facultyuploads/Banu.jpeg', 'IT', 'Assistant Professor', NULL),
(7, 'Ms.Nincy Ettappatt', 'facultyuploads/Nincy.jpeg', 'IT', 'Assistant Professor', NULL),
(8, 'Ms.Princy N K', 'facultyuploads/Princy.jpeg', 'IT', 'Assistant Professor', NULL),
(9, 'Mr.Swaradh P', 'facultyuploads/Swaradh.jpeg', 'IT', 'Assistant Professor', NULL),
(10, 'Ms.Ancy P', 'facultyuploads/Ansy.jpeg', 'IT', 'Instructor', NULL),
(11, 'Ms.Shayana Prakash', 'facultyuploads/Shayana.jpeg', 'IT', 'Instructor', NULL);
...
(3, '3d-portrait-people.jpg', 'kannan', 'hi hows this for a slider', 1, '', NULL, 1),
...
(10, 'college1.jpeg', 'CUIET', 'Building a better world', 1, '', '', 2);
